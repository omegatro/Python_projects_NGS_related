...
folder_path_to_check = "C:\\Users\\omega\\PycharmProjects\\PythonLearn101\\Test_files\\Barcode_reports"
file_list = os.listdir(folder_path_to_check)
print("There are the following .html files in the  Barcode report folder: ")
[print("    " + f_name) for f_name in file_list if ".html" in f_name]
file_count = 0
deleted_files = []
user_confirm = input("Type y to confirm cleanup operation for Barcode reports: ")
if user_confirm == "y":
